...
FEAT_PATHS = {
    "small": "data/features/mad/umlips/mace/mp-a0/mace-mp-0a-small.npy",
    "medium": "data/features/mad/umlips/mace/mp-a0/mace-mp-0a-medium.npy",
    "large": "data/features/mad/umlips/mace/mp-a0/mace-mp-0a-large.npy",
}
