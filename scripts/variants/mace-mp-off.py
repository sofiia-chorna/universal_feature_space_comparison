...
KEY = "mace-mp-off"
SAVE_DIR = "./results/reconstruction_errors/variants/mace/mace_mp_off"
os.makedirs(SAVE_DIR, exist_ok=True)


FEAT_PATHS = {
    "mp-0b3": "data/features/mad/umlips/mace/variants/mace-mp-0b3-medium_organic.npy",
    "off23": "data/features/mad/umlips/mace/off23/mace-off23-medium.npy",
}
